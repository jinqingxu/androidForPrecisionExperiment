...
public class LoginScreen extends Activity {
    ...
    // to record the timestamp of first touch down after selecting the center of CrossHair and timestamp for finalLiftUp.
    // Then we can omit those data before warming up.
    ...
    public void createAllFiles(){
        ...
        //createExternalFile("PID"+pid+"_CrossHair_Data_External.csv" ,"CrossHair Task","timestamp");
